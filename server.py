...
class Server(object):
    ...
    * self.room: one of 0, 1, 2, 3. This signifies which "room" the client is in,
    ...
    def room_description(self, room_number):
        ...
        # TODO: YOUR CODE HERE
        if room_number == 0:
            return 'You are in the room with white wallpaper'
        elif room_number == 1:
            return 'You are in the room with green wallpaper'
        elif room_number == 2:
            return 'You are in the room with brown wallpaper'
        elif room_number == 3:
            return 'You are in the room with blue wallpaper'
